  ...
  return (
    <section id="footer">
      ...
      <button
        onClick={scrollToTop}
        style={{ zIndex: 100 }}
        className={`fixed bottom-5 right-5 w-12 h-12 p-3 m-5 bg-[#FFA726] text-[#030618] hover:text-[#464c6a] font-bold rounded-full shadow-lg hover:bg-[#BDBDBD] transition-opacity duration-300 transform ${
